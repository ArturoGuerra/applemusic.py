...
from apitypes.albums import Album, AlbumRelationships
from apitypes.artists import ArtistsRelationship
from apitypes.songs import SongsRelationship
...
if __name__ == "__main__":
    ...
    try:
        album = m.get_catalog_album("310730204")
